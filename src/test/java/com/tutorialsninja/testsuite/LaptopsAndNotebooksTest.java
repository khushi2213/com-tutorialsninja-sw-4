...
public class LaptopsAndNotebooksTest extends BaseTest {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        checkOutPage.enterEmail("khushi123@gmail.com");
        checkOutPage.enterPhoneNumber("0744667788");
        checkOutPage.enterAddress1("32 Waywerly Road");
        checkOutPage.enterCity("London");
        checkOutPage.enterPostCode("HA2 9RE");
